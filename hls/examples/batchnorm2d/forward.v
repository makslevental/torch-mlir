...
wire   [0:0] exitcond_flatten13_fu_147_p2;
...
reg   [0:0] exitcond_flatten13_reg_180;
wire    ap_block_pp0_stage0_11001;
wire   [8:0] indvar_flatten_next12_fu_153_p2;
reg   [8:0] indvar_flatten_next12_reg_184;
wire    ap_CS_fsm_pp0_stage1;
wire    ap_block_state2_pp0_stage1_iter0;
wire    ap_block_pp0_stage1_11001;
wire   [31:0] grp_fu_134_p2;
reg   [31:0] val_2_reg_194;
wire    ap_CS_fsm_pp0_stage8;
wire    ap_block_state9_pp0_stage8_iter0;
wire    ap_block_pp0_stage8_11001;
reg    ap_enable_reg_pp0_iter0_reg;
reg   [8:0] indvar_flatten11_fu_112;
wire    ap_loop_init;
reg   [8:0] ap_sig_allocacmp_indvar_flatten11_load;
wire    ap_block_pp0_stage0;
wire   [31:0] empty_3_fu_168_p1;
...
always @ (posedge ap_clk) begin
    if ((ap_enable_reg_pp0_iter0 == 1'b1)) begin
        if ((1'b1 == ap_condition_395)) begin
            indvar_flatten11_fu_112 <= 9'd0;
        end else if ((1'b1 == ap_condition_138)) begin
            indvar_flatten11_fu_112 <= indvar_flatten_next12_reg_184;
        end
    end
end
...
always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0))) begin
        exitcond_flatten13_reg_180 <= exitcond_flatten13_fu_147_p2;
        indvar_flatten_next12_reg_184 <= indvar_flatten_next12_fu_153_p2;
    end
end

always @ (posedge ap_clk) begin
    if (((1'b0 == ap_block_pp0_stage8_11001) & (1'b1 == ap_CS_fsm_pp0_stage8) & (exitcond_flatten13_reg_180 == 1'd0))) begin
        val_2_reg_194 <= grp_fu_134_p2;
    end
end

always @ (*) begin
    if (((exitcond_flatten13_fu_147_p2 == 1'd1) & (1'b0 == ap_block_pp0_stage0_subdone) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage21_subdone) & (1'b1 == ap_CS_fsm_pp0_stage21) & (ap_enable_reg_pp0_iter0 == 1'b1))) begin
        ap_ready_int = 1'b1;
    end else begin
        ap_ready_int = 1'b0;
    end
...
always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter0 == 1'b1) & (ap_loop_init == 1'b1))) begin
        ap_sig_allocacmp_indvar_flatten11_load = 9'd0;
    end else begin
        ap_sig_allocacmp_indvar_flatten11_load = indvar_flatten11_fu_112;
    end
end

always @ (*) begin
    if (((1'b0 == ap_block_pp0_stage0_01001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_enable_reg_pp0_iter1 == 1'b1))) begin
        arg_3_o = empty_3_fu_168_p1;
    end else begin
        arg_3_o = arg_3_i;
    end
end
...
always @ (*) begin
    ap_condition_138 = ((1'b0 == ap_block_pp0_stage1_11001) & (1'b1 == ap_CS_fsm_pp0_stage1) & (exitcond_flatten13_reg_180 == 1'd0));
end

always @ (*) begin
    ap_condition_395 = ((1'b0 == ap_block_pp0_stage0_11001) & (1'b1 == ap_CS_fsm_pp0_stage0) & (ap_loop_init == 1'b1));
end
...
assign empty_3_fu_168_p1 = grp_fu_129_p2;

assign exitcond_flatten13_fu_147_p2 = ((ap_sig_allocacmp_indvar_flatten11_load == 9'd400) ? 1'b1 : 1'b0);

assign grp_fu_134_p0 = arg_3_i;

assign indvar_flatten_next12_fu_153_p2 = (ap_sig_allocacmp_indvar_flatten11_load + 9'd1);
