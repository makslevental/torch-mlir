...
def foo():
    for i in ast_tools.macros.unroll(range(1, 10, 2)):
        for j in ast_tools.macros.unroll(range(1, 10, 2)):
            print(i*j)
...
def forward():
    ...
    _arg0=np.empty((1, 1, 11, 11))
    _arg1=np.empty((1, 16, 9, 9))
    _0 =  __constant_16x1x3x3xf32
    # %1 = memref.get_global @__constant_16xf32 : memref<16xf32>
    _1 = __constant_16xf32
    # scf.for %arg2 = %c0 to %c1 step %c1 {
    for _arg2 in ast_tools.macros.unroll(range(0, 1, 1)):
        # scf.for %arg3 = %c0 to %c16 step %c1 {
        for _arg3 in ast_tools.macros.unroll(range(0, 16, 1)):
            # scf.for %arg4 = %c0 to %c9 step %c1 {
            for _arg4 in ast_tools.macros.unroll(range(0, 9, 1)):
                # scf.for %arg5 = %c0 to %c9 step %c1 {
                for _arg5 in ast_tools.macros.unroll(range(0, 9, 1)):
                    # memref.store %2, %arg1[%arg2, %arg3, %arg4, %arg5] : memref<1x16x9x9xf32>
                    _arg1[_arg2, _arg3, _arg4, _arg5] = _1[_arg3,]
        ...
        for _arg3 in ast_tools.macros.unroll(range(0, 16, 1)):
            ...
            for _arg4 in ast_tools.macros.unroll(range(0, 9, 1)):
                ...
                for _arg5 in ast_tools.macros.unroll(range(0, 9, 1)):
                    ...
                    for _arg6 in ast_tools.macros.unroll(range(0, 1, 1)):
                        # scf.for %arg7 = %c0 to %c3 step %c1 {
                        for _arg7 in ast_tools.macros.unroll(range(0, 3, 1)):
                            # scf.for %arg8 = %c0 to %c3 step %c1 {
                            for _arg8 in ast_tools.macros.unroll(range(0, 3, 1)):
                                # %4 = memref.load %arg0[%arg2, %arg6, %2, %3] : memref<1x1x11x11xf32>
                                _4 = _arg0[_arg2, _arg6, _arg4 + _arg7, _arg5 + _arg8]
